...
public class LocationService {
    ...
    public void completeStay(Long memberId, LocationRequest request) {
        ...
        // 같은 날 같은 행사로 이미 완료된 기록이 있으면 이번 완료는 저장하지 않음 (하루 한 건만)
        ...
        boolean sameDayAlreadyCompleted = completedSameEvent.stream()
                .anyMatch(s -> s.getStartTime() != null && s.getStartTime().toLocalDate().equals(today));
