// app/(tabs)/mypage/participation-history.tsx – 서버에 저장된 입장·퇴장 기록 전체
    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right", "bottom"]}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>참여 서버 기록</Text>
          <View style={{ width: 22 }} />
        </View>

        <Text style={styles.subtitle}>입장·퇴장이 기록된 모든 축제 참여 내역입니다.</Text>
        ...
        {loading && list.length === 0 ? (
          ...
          >
            {list.length === 0 ? (
              <Text style={styles.empty}>입장·퇴장 기록이 없습니다.</Text>
            ) : (
...
const styles = StyleSheet.create({
  ...
  contents: { padding: 16, paddingBottom: 24 },
